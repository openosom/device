...
#if defined(SOC_IS_S3C2410)
#	define CONFIG_S3C2410		1	/* specifically a SAMSUNG S3C2410 SoC	*/
#elif defined(SOC_IS_S3C2440)
#	define	CONFIG_S3C2440		1	/* in a SAMSUNG S3C2440 SoC     */
#else
#	error "NOT S3C2410/S3C2440 SOC"
#endif

#define CONFIG_SMDK2440		1	/* on a friendly-arm SMDK2440 Board  */
...
#define CONFIG_ZIMAGE_BOOT /*support zimage*/
...
#define CONFIG_BOOTARGS		"root=/dev/mtdblock3  console=ttySAC0"
...
#define CONFIG_BOOTCOMMAND	"nboot 0x30008000 kernel;bootm"
...
#define	CONFIG_SYS_PROMPT		"[u-boot@s3c24xx]# "	/* Monitor Command Prompt	*/
...
#define MTDPARTS_DEFAULT "mtdparts=nandflash0:384k(uboot)," \
					      "128k(uboot-env)," \
					      "5m(kernel)," \
					      "-(rootfs)"
...
#define CONFIG_SYS_VIDEO_LOGO_MAX_SIZE         (800*400+100) /* 100 = slack */ 
