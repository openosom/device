/*
 * Samsung S3C2410A/S3C2440/S3C2442 RISC Microprocessor support (ARM920T based SoC).
 *
 * Copyright (c) 2007 OpenMoko, Inc.
 * Author: Andrzej Zaborowski <andrew@openedhand.com>
 * With:       Richard Nee <openme@openwrt.org.cn>
 *
                ...
                struct sd_card_s *mmc)
{
    ...
    s->io = s3c_gpio_init(s->cpu_id, 0x56000000, s->irq);
