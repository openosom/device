...
struct s3c_gpio_state_s *s3c_gpio_init(uint32_t cpu_id, target_phys_addr_t base, qemu_irq *pic);
...
struct s3c_state_s {
    ...
    struct s3c_nand_driver_s *nand; /* NAND Flash controller */
...
/* s3c2410.c, TODO: support s3c24xx */
